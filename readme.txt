...
oceanpayment Klarna payment  plugin

== Description ==
oceanpayment Klarna payment  plugin

== Installation ==
1.install the Oceanpayment-Klarna plug-in in the WordPrwss background.
2.Activate oceanpayment Klarna in the plugin menu.
